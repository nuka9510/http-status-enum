...
export default class HttpStatus extends Enum<number> {
   ...
   */
  static get CONTINUE(): HttpStatus { return HttpStatus.#CONTINUE; }
   ...
   */
  static get SWITCHING_PROTOCOL(): HttpStatus { return HttpStatus.#SWITCHING_PROTOCOL; }
   ...
   */
  static get PROCESSING(): HttpStatus { return HttpStatus.#PROCESSING; }
   ...
   */
  static get EARLY_HINTS(): HttpStatus { return HttpStatus.#EARLY_HINTS; }
   ...
   */
  static get OK(): HttpStatus { return HttpStatus.#OK; }
   ...
   */
  static get CREATED(): HttpStatus { return HttpStatus.#CREATED; }
   ...
   */
  static get ACCEPTED(): HttpStatus { return HttpStatus.#ACCEPTED; }
   ...
   */
  static get NON_AUTHORITATIVE_INFORMATION(): HttpStatus { return HttpStatus.#NON_AUTHORITATIVE_INFORMATION; }
   ...
   */
  static get NO_CONTENT(): HttpStatus { return HttpStatus.#NO_CONTENT; }
   ...
   */
  static get RESET_CONTENT(): HttpStatus { return HttpStatus.#RESET_CONTENT; }
   ...
   */
  static get PARTIAL_CONTENT(): HttpStatus { return HttpStatus.#PARTIAL_CONTENT; }
   ...
   */
  static get MULTI_STATUS(): HttpStatus { return HttpStatus.#MULTI_STATUS; }
   ...
   */
  static get ALREADY_REPORTED(): HttpStatus { return HttpStatus.#ALREADY_REPORTED; }
   ...
   */
  static get IM_USED(): HttpStatus { return HttpStatus.#IM_USED; }
   ...
   */
  static get MULTIPLE_CHOICES(): HttpStatus { return HttpStatus.#MULTIPLE_CHOICES; }
   ...
   */
  static get MOVED_PERMANENTLY(): HttpStatus { return HttpStatus.#MOVED_PERMANENTLY; }
   ...
   */
  static get FOUND(): HttpStatus { return HttpStatus.#FOUND; }
   ...
   */
  static get SEE_OTHER(): HttpStatus { return HttpStatus.#SEE_OTHER; }
   ...
   */
  static get NOT_MODIFIED(): HttpStatus { return HttpStatus.#NOT_MODIFIED; }
   ...
   */
  static get USE_PROXY(): HttpStatus { return HttpStatus.#USE_PROXY; }
   ...
   */
  static get UNUSED(): HttpStatus { return HttpStatus.#UNUSED; }
   ...
   */
  static get TEMPORARY_REDIRECT(): HttpStatus { return HttpStatus.#TEMPORARY_REDIRECT; }
   ...
   ** 만약 첫 요청에 `POST`가 사용되었다면, 두번째 요청도 반드시 `POST`를 사용해야 합니다.
   */
  static get PERMANENT_REDIRECT(): HttpStatus { return HttpStatus.#PERMANENT_REDIRECT; }
   ...
   */
  static get BAD_REQUEST(): HttpStatus { return HttpStatus.#BAD_REQUEST; }
   ...
   */
  static get UNAUTHORIZED(): HttpStatus { return HttpStatus.#UNAUTHORIZED; }
   ...
   */
  static get PAYMENT_REQUIRED(): HttpStatus { return HttpStatus.#PAYMENT_REQUIRED; }
   ...
   */
  static get FORBIDDEN(): HttpStatus { return HttpStatus.#FORBIDDEN; }
   ...
   */
  static get NOT_FOUND(): HttpStatus { return HttpStatus.#NOT_FOUND; }
   ...
   */
  static get METHOD_NOT_ALLOWED(): HttpStatus { return HttpStatus.#METHOD_NOT_ALLOWED; }
   ...
   */
  static get NOT_ACCEPTABLE(): HttpStatus { return HttpStatus.#NOT_ACCEPTABLE; }
   ...
   */
  static get PROXY_AUTHENTICATION_REQUIRED(): HttpStatus { return HttpStatus.#PROXY_AUTHENTICATION_REQUIRED; }
   ...
   */
  static get REQUEST_TIMEOUT(): HttpStatus { return HttpStatus.#REQUEST_TIMEOUT; }
   ...
   */
  static get CONFLICT(): HttpStatus { return HttpStatus.#CONFLICT; }
   ...
   */
  static get GONE(): HttpStatus { return HttpStatus.#GONE; }
   ...
   */
  static get LENGTH_REQUIRED(): HttpStatus { return HttpStatus.#LENGTH_REQUIRED; }
   ...
   */
  static get PRECONDITION_FAILED(): HttpStatus { return HttpStatus.#PRECONDITION_FAILED; }
   ...
   */
  static get CONTENT_TOO_LARGE(): HttpStatus { return HttpStatus.#CONTENT_TOO_LARGE; }
   ...
   */
  static get URI_TOO_LONG(): HttpStatus { return HttpStatus.#URI_TOO_LONG; }
   ...
   * 서버는 해당 요청을 거절할 것입니다.
   */
  static get UNSUPPORTED_MEDIA_TYPE(): HttpStatus { return HttpStatus.#UNSUPPORTED_MEDIA_TYPE; }
   ...
   */
  static get RANGE_NOT_SATISFIABLE(): HttpStatus { return HttpStatus.#RANGE_NOT_SATISFIABLE; }
   ...
   */
  static get EXPECTATION_FAILED(): HttpStatus { return HttpStatus.#EXPECTATION_FAILED; }
   ...
   */
  static get IM_A_TEAPOT(): HttpStatus { return HttpStatus.#IM_A_TEAPOT; }
   ...
   */
  static get MISDIRECTED_REQUEST(): HttpStatus { return HttpStatus.#MISDIRECTED_REQUEST; }
   ...
   */
  static get UNPROCESSABLE_ENTITY(): HttpStatus { return HttpStatus.#UNPROCESSABLE_ENTITY; }
   ...
   * 리소스는 접근하는 것이 잠겨있습니다.
   */
  static get LOCKED(): HttpStatus { return HttpStatus.#LOCKED; }
   ...
   */
  static get FAILED_DEPENDENCY(): HttpStatus { return HttpStatus.#FAILED_DEPENDENCY; }
   ...
   */
  static get UPGRADE_REQUIRED(): HttpStatus { return HttpStatus.#UPGRADE_REQUIRED; }
   ...
   */
  static get PRECONDITION_REQUIRED(): HttpStatus { return HttpStatus.#PRECONDITION_REQUIRED; }
   ...
   */
  static get TOO_MANY_REQUESTS(): HttpStatus { return HttpStatus.#TOO_MANY_REQUESTS; }
   ...
   */
  static get REQUEST_HEADER_FIELDS_TOO_LARGE(): HttpStatus { return HttpStatus.#REQUEST_HEADER_FIELDS_TOO_LARGE; }
   ...
   */
  static get UNAVAILABLE_FOR_LEGAL_REASONS(): HttpStatus { return HttpStatus.#UNAVAILABLE_FOR_LEGAL_REASONS; }
   ...
   */
  static get INTERNAL_SERVER_ERROR(): HttpStatus { return HttpStatus.#INTERNAL_SERVER_ERROR; }
   ...
   * 이 코드는 반환하면 안됩니다.
   */
  static get NOT_IMPLEMENTED(): HttpStatus { return HttpStatus.#NOT_IMPLEMENTED; }
   ...
   */
  static get BAD_GATEWAY(): HttpStatus { return HttpStatus.#BAD_GATEWAY; }
   ...
   */
  static get SERVICE_UNAVAILABLE(): HttpStatus { return HttpStatus.#SERVICE_UNAVAILABLE; }
   ...
   */
  static get GATEWAY_TIMEOUT(): HttpStatus { return HttpStatus.#GATEWAY_TIMEOUT; }
   ...
   */
  static get HTTP_VERSION_NOT_SUPPORTED(): HttpStatus { return HttpStatus.#HTTP_VERSION_NOT_SUPPORTED; }
   ...
   */
  static get VARIANT_ALSO_NEGOTIATES(): HttpStatus { return HttpStatus.#VARIANT_ALSO_NEGOTIATES; }
   ...
   */
  static get INSUFFICIENT_STORAGE(): HttpStatus { return HttpStatus.#INSUFFICIENT_STORAGE; }
   ...
   */
  static get LOOP_DETECTED(): HttpStatus { return HttpStatus.#LOOP_DETECTED; }
   ...
   */
  static get NOT_EXTENDED(): HttpStatus { return HttpStatus.#NOT_EXTENDED; }
   ...
   */
  static get NETWORK_AUTHENTICATION_REQUIRED(): HttpStatus { return HttpStatus.#NETWORK_AUTHENTICATION_REQUIRED; }
